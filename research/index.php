...
<div class="row">
    <div id="main-content" class="column">
        ...
        <p>My current book project is about the various textual formalisms that undergird machine
        reading and writing. Read more <a href="./research/literalism">here</a>.</p>
        <hr>
        <h4>Digital Projects (Selected)</h4>
        <p>The English Broadside Ballad Archive <a href="./research/ebba">+</a></p>
        <p style="margin-left: 35px">Digitizing, transcribing, and creating analytical tools for
        over 9,000 seventeenth-century ballads.</p>
        <p>The Maker Lab <a href="./research/maker-lab">+</a></p>
        <p style="margin-left: 35px">Printing post-digitally, with 3D printers, woodblocks, type,
        and a pull press.</p>
