...
<div class="row">
    <div id="main-content" class="column">
        ...
        <p><b>Website:</b> <a href="http://watereview.ucdavis.edu"
        target="_blank">watereview.ucdavis.edu</a></p>
        <hr>
        <p>wateReview is a corpus exploration platform that supports a data-driven literature review
        of water management in the Caribbean and South and Central America (titled <a
        href="https://hess.copernicus.org/preprints/hess-2021-106/" target="_blank">"Bright and
        Blind Spots of Water Research in Latin America and the Caribbean"</a>). Working in
        collaboration with wateReview's domain experts, I built this platform and its many
        ...
        specific research metrics for each country we studied.</p>
    </div>
